...
| `chore-engine-queued-pin` | The queued-cleanups engine-test pin: `player + queued + autoPilot: false` commits the queued order | Codex | running — dispatched 2026-08-18, test-only, `server/test/` |
